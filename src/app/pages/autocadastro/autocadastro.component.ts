...
export class AutocadastroComponent {
  ...
  constructor(private clienteService: ClienteService, private autocadastroService: AutocadastroService, private gerenteService : GerenteService,  private http: HttpClient) { }
